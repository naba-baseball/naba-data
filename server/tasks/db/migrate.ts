...
export default defineTask({
  ...
  async run() {
    ...
    const db = useSQLite();
    await db.run(migratePlayers());
    await db.run(migratePlayersBatting());
    await db.run(migratePlayersPitching());
    await db.run(migratePlayersFielding());
    await db.run(migrateTeams());
    await db.run(migrateTeamRoster());
    for(const statement of migrateIndexes()){
...
function migratePlayers() {
  return sql`CREATE TABLE 'players' (
    'player_id' integer,
    'team_id' integer,
    'league_id' integer,
    'position' integer,
...
function migratePlayersBatting() {
  return sql`CREATE TABLE 'players_batting' (
    'player_id' integer,
    'team_id' integer,
    'league_id' integer,
    'position' integer,
...
function migratePlayersPitching() {
  return sql`CREATE TABLE 'players_pitching' (
    'player_id' integer,
    'team_id' integer,
    'league_id' integer,
    'position' integer,
...
function migratePlayersFielding(){
  return sql`CREATE TABLE 'players_fielding' (
    'player_id' integer,
    'team_id' integer,
    'league_id' integer,
    'position' integer,
...
function migrateTeamRoster() {
  return sql`CREATE TABLE 'team_roster' (
    'team_id' integer,
    'player_id' integer,
    'list_id' integer
  );`;
...
function migrateIndexes() {
  return [
    // sql`CREATE UNIQUE INDEX 'id_idx' ON 'players' ('player_id')`,
    sql`CREATE INDEX 'player_team_id_idx' ON 'players' ('team_id')`,
    // sql`CREATE UNIQUE INDEX 'batting_rating_player_id_idx' ON 'players_batting' ('player_id')`,
    sql`CREATE INDEX 'batting_rating_team_id_idx' ON 'players_batting' ('team_id')`,
    // sql`CREATE UNIQUE INDEX 'pitching_rating_player_id_idx' ON 'players_pitching' ('player_id')`,
    sql`CREATE INDEX 'pitching_rating_team_id_idx' ON 'players_pitching' ('team_id')`,
    sql`CREATE INDEX 'team_roster_player_id_idx' ON 'team_roster' ('player_id')`,
    sql`CREATE INDEX 'team_roster_team_id_idx' ON 'team_roster' ('team_id')`,
    sql`CREATE INDEX 'team_roster_list_id_idx' ON 'team_roster' ('list_id')`,
    // sql`CREATE UNIQUE INDEX 'team_id_idx' ON 'teams' ('team_id');`,
  ];
}
