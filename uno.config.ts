...
export default defineConfig({
  ...
  shortcuts: {
    ...
    select:
      "block rounded py-2xs ps-2xs pe-lg border-primary/30 shadow-sm border border-solid",
    "tab-trigger":
      "data-[active=false]:text-text-contrast cursor-pointer bg-transparent  p-2xs border-none",
  },
  preflights: [
    {
      getCSS: ({ theme }) => `
